...
const condo = condominios.find(
  c => Number(c.id) === Number(u.condominio_id)
);
                    return (
                      <tr key={u.id}>
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <div className="modal-header">
              <h2>
                {isViewOnly ? 'Visualizar' : editingId ? 'Editar' : 'Novo'} Usuário
              </h2>
